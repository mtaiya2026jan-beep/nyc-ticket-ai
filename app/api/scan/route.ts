      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: systemPrompt },
          {
            role: 'user',
            content: [
              ...pages.map((p: {base64: string, mimeType: string}) => ({ type: 'image_url' as const, image_url: { url: `data:${p.mimeType};base64,${p.base64}`, detail: 'high' as const } })),
